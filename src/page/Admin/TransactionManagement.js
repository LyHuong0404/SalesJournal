...
function TransactionManagement() {
    ...
    const handleChangeSerivePackage = (item) => {
        ...
        } else setServicePackageId(item.id);
        ...
        <View style={styles.container}>
            ...
            <View style={{ marginHorizontal: 15 }}>
                ...
                <View style={{ display: 'flex', flexDirection: 'row' }}>
                    <Text style={{ fontWeight: '600', marginVertical: 10, color: '#6a6a6a' }}>Gói giao dịch</Text>
                    <Dropdown
                ...
                <View style={{ display: 'flex', flexDirection: 'row' }}>
                    <Text style={{ fontWeight: '600', marginVertical: 10, marginRight: 25, color: '#6a6a6a' }}>Trạng thái</Text>
                    <Dropdown
